...
import { Calendar, Clock, X, AlertTriangle, DollarSign, CheckCircle } from 'lucide-react';
      ...
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
        <div className="bg-white rounded-2xl p-8 w-full max-w-md text-center">
          ...
          <p className="text-gray-600 mb-2">
            {workerName
              ? <>Your booking request has been sent to <span className="font-medium">{workerName}</span>.</>
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={() => { onCancel(); navigate('/bookings'); }}
              className="flex-1 px-4 py-2 bg-trust-600 text-white rounded-lg hover:bg-trust-700 transition-colors"
            >
              View My Bookings
            </button>
          </div>
